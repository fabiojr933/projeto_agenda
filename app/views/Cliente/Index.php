				...
				<div class="tabela-responsiva">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="dataTable">
						...
						<?php foreach($lista as $cliente) {  ?>
							<tr>
								<td><?php echo isset($cliente->id_cliente) ? $cliente->id_cliente : null ?></td>
								<td><?php echo isset($cliente->cliente) ? $cliente->cliente : null ?></td>
								<td><?php echo isset($cliente->email) ? $cliente->email : null ?></td>
								<td align="center"><?php echo isset($cliente->celular) ? $cliente->celular : null ?></td>
								<td align="center">
